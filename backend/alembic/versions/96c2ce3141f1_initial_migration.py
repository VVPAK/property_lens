...
Revision ID: 96c2ce3141f1
Revises: 
Create Date: 2026-01-28 20:23:52.397419
...
def upgrade() -> None:
    ...
    sa.Column('estimated_rent_yearly', sa.Float(), nullable=True),
    ...
    op.create_index(op.f('ix_properties_area_name'), 'properties', ['area_name'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_properties_area_name'), table_name='properties')
